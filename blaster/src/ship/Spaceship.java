...
// methods:
	...
	// thrustForward() - increases the speed, if speed > 0, places momentum in flag loop
	...
	//				   if Player has another life, spawns spaceship in random SAFE place in Panel
